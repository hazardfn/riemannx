defmodule Riemannx.Connections.TLS do
  ...
  * This library was built for my use-case which required speed at the expense
  ...
  def send(e, t),
    do: GenServer.call(Connection.checkout(:tls, :sync), {:send_msg, e}, t)

  def send_async(e),
    do: GenServer.cast(Connection.checkout(:tls, :async), {:send_msg, e})

  def query(m, t),
    do: GenServer.call(Connection.checkout(:tls, :sync), {:send_msg, m, t})
